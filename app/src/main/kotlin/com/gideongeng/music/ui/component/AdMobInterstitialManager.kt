...
class AdMobInterstitialManager(
    ...
    private val onFirstAdLoaded: () -> Unit = {}
) {
     ...
     * @param ignoreFrequency If true, ignores the time check
     * @return true if ad was shown, false otherwise
     */
    fun showAdIfAvailable(activity: Activity, ignoreFrequency: Boolean = false): Boolean {
        val currentTime = System.currentTimeMillis()
        
        // Check if enough time has passed since last ad
        if (!ignoreFrequency && currentTime - lastAdShownTime < minTimeBetweenAds) {
